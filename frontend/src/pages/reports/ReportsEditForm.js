  ...
  useEffect(() => {
    const handleMount = async () => {
      try {
        ...
        is_owner
          ? setReportsData({ subject, message, report_reason, post })
          : history.push("/");
      } catch (err) {}
    };
    ...
    <Row>
      ...
      <Col md={6} className="my-auto d-none d-md-block p-2">
        <Image
          ...
          src={
            "https://res.cloudinary.com/emmavkarlsson/image/upload/v1700218039/pexels-tara-winstead-8850750_sfh5b6.jpg"
          }
        />
      </Col>
    </Row>
